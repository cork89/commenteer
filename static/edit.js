...
const borderColors = { 1: ["border-slate-500", "#64748B"], 2: ["border-red-700", "#B91C1C"], 3: ["border-blue-700", "#1D4ED8"], 4: ["border-emerald-700", "#047857"], 5: ["border-yellow-500", "#EAB308"], 6: ["border-stone-900", "#1C1917"] }
...
function borderColor(newState) {
    ...
    icc.classList.remove("border-slate-500", "border-red-700", "border-blue-700", "border-emerald-700", "border-yellow-500", "border-stone-900")
